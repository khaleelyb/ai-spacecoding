...
const FileTree: React.FC<FileTreeProps> = ({ entries, activeId, onSelect, onNewFile, onNewFolder, onFileUpload }) => {
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm">
      ...
      <div className="p-3 grid grid-cols-2 gap-2 bg-gray-50 border-b border-gray-200">
        ...
        <button onClick={onNewFolder} className="bg-white hover:bg-gray-50 text-gray-700 font-medium py-2 px-2 rounded-lg text-xs transition-all duration-200 flex items-center justify-center space-x-1.5 border border-gray-200 shadow-sm hover:shadow">
         ...
         <button onClick={handleUploadClick} className="col-span-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-3 rounded-lg text-xs transition-all duration-200 flex items-center justify-center space-x-2 shadow-sm hover:shadow-md">
